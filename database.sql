...
INSERT INTO `admin_menus` (`id`, `parent_id`, `order`, `title`, `icon`, `url`, `url_type`, `visible`, `is_home`, `component`, `is_full`, `extension`, `created_at`, `updated_at`) VALUES
(1, 0, 0, '首页', 'ph:chart-line-up-fill', '/dashboard', 1, 1, 1, NULL, 0, NULL, NULL, NULL),
(2, 0, 20, '系统管理', 'material-symbols:settings-outline', '/system', 1, 1, 0, NULL, 0, NULL, NULL, '2023-01-31 06:54:21'),
(3, 2, 0, '管理员', 'ph:user-gear', '/system/admin_users', 1, 1, 0, NULL, 0, NULL, NULL, NULL),
(4, 2, 10, '角色', 'carbon:user-role', '/system/admin_roles', 1, 1, 0, NULL, 0, NULL, NULL, NULL),
(5, 2, 20, '权限', 'fluent-mdl2:permissions', '/system/admin_permissions', 1, 1, 0, NULL, 0, NULL, NULL, NULL),
(6, 2, 30, '菜单', 'ant-design:menu-unfold-outlined', '/system/admin_menus', 1, 1, 0, NULL, 0, NULL, NULL, NULL),
(8, 0, 10, 'Json示例', 'material-symbols:border-all-rounded', '/example', 1, 1, 0, NULL, 0, NULL, '2022-09-06 10:32:40', '2023-01-31 06:54:21'),
(9, 8, 10, '所有Form示例', 'ph:circle', '/example/form_all', 1, 1, 0, NULL, 0, NULL, '2022-09-06 10:34:10', '2022-09-06 11:05:12'),
(10, 8, 60, '表单展示模式', 'ph:circle', '/example/form', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:05:57', '2022-09-06 11:05:57'),
(11, 8, 0, '显隐切换示例', 'ph:circle', '/example/reaction', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:16:26', '2022-09-06 11:16:34'),
(12, 8, 20, '条件生成器', 'ph:circle', '/example/condition_builder', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:20:12', '2022-09-06 11:20:12'),
(13, 8, 30, '弹框', 'ph:circle', '/example/dialog', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:23:46', '2022-09-06 11:23:46'),
(14, 8, 40, '选项卡', 'ph:circle', '/example/tabs', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:23:46', '2022-09-06 11:23:46'),
(15, 8, 50, '步骤表单', 'ph:circle', '/example/wizard', 1, 1, 0, NULL, 0, NULL, '2022-09-06 11:23:46', '2022-09-06 11:23:46');
...
(1, '首页', 'dashboard', NULL, '[\"\\/dashboard*\"]', 0, 0, NULL, NULL),
(2, '系统管理', 'system', NULL, '[\"\\/system*\"]', 10, 0, NULL, '2023-01-31 06:54:21'),
(3, '管理员', 'system.admin_users', NULL, '[\"\\/system\\/admin_users*\"]', 0, 2, NULL, NULL),
(4, '角色', 'system.admin_roles', NULL, '[\"\\/system\\/admin_roles*\"]', 10, 2, NULL, NULL),
(5, '权限', 'system.admin_permissions', NULL, '[\"\\/system\\/admin_permissions*\"]', 20, 2, NULL, NULL),
(6, '菜单', 'system.admin_menus', NULL, '[\"\\/system\\/admin_menus*\"]', 30, 2, NULL, NULL),
(8, 'Json示例', 'example', NULL, '[\"\\/example*\"]', 20, 0, '2022-09-06 10:32:40', '2023-01-31 06:54:21'),
(9, '所有Form示例', 'example.form_all', NULL, '[\"\\/example\\/form_all*\"]', 10, 8, '2022-09-06 10:34:10', '2022-09-06 11:05:12'),
(10, '表单展示模式', 'example.form', NULL, '[\"\\/example\\/form*\"]', 60, 8, '2022-09-06 11:05:57', '2022-09-06 11:05:57'),
(11, '显隐切换示例', 'example.reaction', NULL, '[\"\\/example\\/reaction*\"]', 0, 8, '2022-09-06 11:16:26', '2022-09-06 11:16:34'),
(12, '条件生成器', 'example.condition_builder', NULL, '[\"\\/example\\/condition_builder*\"]', 20, 8, '2022-09-06 11:20:12', '2022-09-06 11:20:12'),
(13, '弹框', 'example.dialog', NULL, '[\"\\/example\\/dialog*\"]', 30, 8, '2022-09-06 11:23:46', '2022-09-06 11:23:46'),
(14, '选项卡', 'example.tabs', NULL, '[\"\\/example\\/tabs*\"]', 40, 8, '2022-09-06 11:23:46', '2022-09-06 11:23:46'),
(15, '步骤表单', 'example.wizard', NULL, '[\"\\/example\\/wizard*\"]', 50, 8, '2022-09-06 11:23:46', '2022-09-06 11:23:46');
...
('system_theme_setting', '{\"darkTheme\":false,\"footer\":true,\"breadcrumb\":true,\"themeColor\":\"#1677ff\",\"layoutMode\":\"double\",\"siderTheme\":\"light\",\"topTheme\":\"light\",\"animateInType\":\"alpha\",\"animateInDuration\":700,\"animateOutType\":\"alpha\",\"animateOutDuration\":600,\"loginTemplate\":\"default\",\"keepAlive\":false,\"enableTab\":true,\"tabIcon\":true,\"accordionMenu\":true}', NULL, '2024-03-20 10:53:40');
